...
io.on("connect", socket => {
  const undefinedUser = new classes.Profile("Albert", "Einstein", "1879-03-14", null, "usuario_1@gmail.com", "https://cdn4.iconfinder.com/data/icons/avatars-xmas-giveaway/128/scientist_einstein_avatar_professor-256.png");
  console.log(`connection_identifier: ${socket.id}`);
  socket.emit("profile", undefinedUser);
  dataHandler.getMessages().then(rows => {
